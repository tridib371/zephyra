...
const Login = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-1/3 left-12 w-80 sm:w-96 h-80 sm:h-96 bg-gradient-to-br from-[#FF8F6B]/20 to-[#F5C36B]/15 dark:from-[#8B5CF6]/20 dark:to-[#EC4899]/15 rounded-full blur-2xl pointer-events-none transform-gpu" />
            <div className="absolute bottom-1/3 right-12 w-80 sm:w-96 h-80 sm:h-96 bg-gradient-to-br from-[#06B6D4]/15 to-[#3B82F6]/15 dark:from-[#FF8F6B]/20 dark:to-[#F5C36B]/15 rounded-full blur-2xl pointer-events-none transform-gpu" />
