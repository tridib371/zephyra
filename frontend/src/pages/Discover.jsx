    ...
    return (
        ...
        >
            <div className="max-w-4xl mx-auto space-y-6">
                <div>
                    <h1 className="text-3xl sm:text-4xl font-['Fraunces'] italic font-bold text-[#101828] dark:text-[#EDEBE6]">
                        Discover Creators
                    </h1>
                ...
                {users.length === 0 ? (
                    <div className="bg-white dark:bg-[#12151C] rounded-3xl shadow-xs p-8 text-center border border-[#EAECF0] dark:border-[#1F232C]">
                        <p className="text-[#475467] dark:text-[#8A8F9C] text-sm">No other users found yet. Invite some friends to join!</p>
                    </div>
                ) : (
                        ...
                        {users.map((user) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="bg-white dark:bg-[#12151C] rounded-3xl shadow-xs p-5 border border-[#EAECF0] dark:border-[#1F232C] hover:border-[#D97B4F]/50 dark:hover:border-[#F5C36B]/30 transition-all duration-300"
                                >
                                    <Link to={`/profile/${user._id}`} className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="font-bold text-[#101828] dark:text-[#EDEBE6] truncate text-sm">
                                                {user.name}
                                            </p>
                                            <p className="text-xs text-[#667085] dark:text-[#6E7280] truncate font-mono">
                                                @{user.username}
                                            </p>
                                            <p className="text-[11px] text-[#667085] dark:text-[#6E7280] mt-0.5 font-medium">
