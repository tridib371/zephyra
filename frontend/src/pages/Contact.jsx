        ...
        <div className="min-h-screen bg-[#F6EFE6] dark:bg-[#0E1116] text-[#1F1710] dark:text-[#EDEBE6] transition-colors duration-300 py-12 px-4 sm:px-6 lg:px-8 font-[Manrope]">
            <div className="max-w-5xl mx-auto space-y-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {CONTACT_CHANNELS.map((ch) => {
                        ...
                        return (
                            <div
                                key={ch.title}
                                className="p-6 rounded-3xl border border-[#E2D4C3] dark:border-[#1F232C] bg-[#FFFDF9] dark:bg-[#12151C]/95 shadow-[0_8px_30px_-10px_rgba(217,123,79,0.12)] backdrop-blur-xl flex flex-col justify-between gap-4 transition-all hover:border-[#D97B4F]/50"
                            >
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="px-2.5 py-1 rounded-full text-[10px] font-extrabold bg-[#FAF2E8] dark:bg-[#181C26] text-[#5C4A3C] dark:text-gray-400 border border-[#DECDBB] dark:border-[#252A36]">
                                            {ch.responseTime}
                                        </span>
                                    </div>
                                    ...
                                    <p className="text-xs text-[#5C4A3C] dark:text-[#8A8F9C] leading-relaxed font-medium">
                                        {ch.desc}
                                    </p>
                                </div>
                                <a
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-2 rounded-3xl border border-[#E2D4C3] dark:border-[#1F232C] bg-[#FFFDF9] dark:bg-[#12151C]/95 p-6 sm:p-10 shadow-[0_8px_30px_-10px_rgba(217,123,79,0.12)] backdrop-blur-xl">
                        {submitted ? (
                            <motion.div
                                initial={{ scale: 0.95, opacity: 0 }}
                                animate={{ scale: 1, opacity: 1 }}
                                className="p-8 sm:p-12 text-center space-y-5 bg-gradient-to-b from-emerald-50/70 to-[#FFFDF9] dark:from-emerald-950/20 dark:to-[#12151C] rounded-3xl border border-emerald-200/80 dark:border-emerald-900/40 text-emerald-800 dark:text-emerald-300"
                            >
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <h3 className="font-['Fraunces'] font-bold text-2xl text-[#1F1710] dark:text-white">
                                        Message Dispatched!
                                    </h3>
                                    <p className="text-xs sm:text-sm text-[#5C4A3C] dark:text-[#A0A5B2] max-w-md mx-auto leading-relaxed font-medium">
                                        Thank you, <span className="font-bold text-[#1F1710] dark:text-white">{name}</span>. Our team has received your ticket and will send a confirmation and resolution to <span className="font-bold text-[#1F1710] dark:text-white">{email}</span>.
                                    </p>
                                </div>
                                <div className="pt-2">
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border border-[#DECDBB] dark:border-[#2E3544] text-xs font-bold text-[#5C4A3C] dark:text-[#E7E6E3] hover:bg-[#FAF2E8] dark:hover:bg-[#181C26] transition-all cursor-pointer"
                                    >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="border-b border-[#EFE5D8] dark:border-[#1F232C] pb-4">
                                    <h2 className="font-['Fraunces'] text-xl sm:text-2xl font-bold text-[#1F1710] dark:text-white">
                                        Send a Message to Support
                                    </h2>
                                    <p className="text-xs text-[#5C4A3C] dark:text-[#8A8F9C] mt-0.5 font-medium">
                                ...
                                <div className="space-y-2">
                                    <label className="block text-[11px] font-extrabold uppercase tracking-wider text-[#5C4A3C] dark:text-gray-400">
                                                ...
                                                <button
                                                    ...
                                                    className={`p-3 rounded-2xl border text-left flex items-start gap-3 transition-all cursor-pointer ${
                                                        isSelected
                                                            ...
                                                            : 'border-[#DECDBB] dark:border-[#252A36] bg-[#FAF2E8] dark:bg-[#181C26]/70 hover:bg-[#EFE3D4]'
                                                    }`}
                                                >
                                                    <span className={`p-2 rounded-xl text-base shrink-0 ${isSelected ? 'bg-[#D97B4F] text-[#1A140D]' : 'bg-[#EAE0D3] dark:bg-[#202532] text-[#5C4A3C] dark:text-gray-300'}`}>
                                                        <Icon />
                                                    </span>
                                                    <div className="space-y-0.5">
                                                        <p className={`text-xs font-bold ${isSelected ? 'text-[#B85323] dark:text-[#F5C36B]' : 'text-[#1F1710] dark:text-white'}`}>
                                                            {cat.label}
                                                        </p>
                                                        <p className="text-[10px] text-[#665548] dark:text-[#8A8F9C] line-clamp-1 font-medium">
                                                            {cat.desc}
                                                        </p>
                                                    </div>
                                                </button>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full rounded-2xl border border-[#DECDBB] dark:border-[#252A36] bg-[#F4ECE1] dark:bg-[#181C26]/80 px-4 py-3 text-sm text-[#1F1710] dark:text-white focus:outline-none focus:ring-2 focus:ring-[#FF8F6B]/50 transition-all font-medium"
                                        />
                                    </div>
                                    <div className="space-y-1">
                                        <label className="block text-[11px] font-extrabold uppercase tracking-wider text-[#5C4A3C] dark:text-gray-400">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <select
                                            ...
                                            className="w-full rounded-2xl border border-[#DECDBB] dark:border-[#252A36] bg-[#F4ECE1] dark:bg-[#181C26]/80 px-3 py-3 text-xs sm:text-sm text-[#1F1710] dark:text-white focus:outline-none focus:ring-2 focus:ring-[#FF8F6B]/50 transition-all font-medium"
                                        >
                                ...
                                <div className="space-y-1">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[10px] text-[#877568]">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full rounded-2xl border border-[#DECDBB] dark:border-[#252A36] bg-[#F4ECE1] dark:bg-[#181C26]/80 p-4 text-sm text-[#1F1710] dark:text-white focus:outline-none focus:ring-2 focus:ring-[#FF8F6B]/50 resize-none transition-all font-medium"
                                    />
                                </div>
                    ...
                    <div className="space-y-6">
                        <div className="rounded-3xl border border-[#E2D4C3] dark:border-[#1F232C] bg-[#FFFDF9] dark:bg-[#12151C]/95 p-6 sm:p-8 shadow-[0_8px_30px_-10px_rgba(217,123,79,0.12)] space-y-4">
                            <div className="flex items-center gap-2.5 text-[#1F1710] dark:text-white font-bold text-sm">
                            ...
                            <div className="space-y-2.5 pt-2">
                                {QUICK_FAQS.map((faq, idx) => {
                                    ...
                                    return (
                                        <div
                                            key={faq.q}
                                            className="rounded-2xl border border-[#DECDBB] dark:border-[#202532] bg-[#FAF2E8] dark:bg-[#181C26]/60 overflow-hidden text-xs"
                                        >
                                            <button
                                                type="button"
                                                onClick={() => toggleFaq(idx)}
                                                className="w-full text-left p-3.5 flex items-center justify-between gap-2 font-bold text-[#1F1710] dark:text-gray-200 hover:text-[#D97B4F] dark:hover:text-[#F5C36B] cursor-pointer"
                                            >
                                                <span>{faq.q}</span>
                                                <span className="shrink-0 text-[#877568]">
                                            ...
                                            <AnimatePresence>
                                                {isOpen && (
                                                    <motion.div
                                                        ...
                                                        className="px-3.5 pb-3.5 text-[#5C4A3C] dark:text-[#A0A5B2] leading-relaxed border-t border-[#DECDBB] dark:border-[#202532] pt-2 font-medium"
                                                    >
                                                        {faq.a}
                                                    </motion.div>
                                                )}
                            ...
                            <div className="pt-2 border-t border-[#EFE5D8] dark:border-[#1F232C]">
                                <Link
                                    to="/support"
                        ...
                        {/* Privacy & Safety Note */}
                        <div className="p-6 rounded-3xl border border-[#E2D4C3] dark:border-[#1F232C] bg-[#FFFDF9] dark:bg-[#12151C] space-y-2 text-xs text-[#5C4A3C] dark:text-[#9DA3B4] leading-relaxed shadow-[0_8px_30px_-10px_rgba(217,123,79,0.12)]">
                            <div className="flex items-center gap-2 font-bold text-[#1F1710] dark:text-white text-xs">
