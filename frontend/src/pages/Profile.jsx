            ...
            >
                <div className="max-w-4xl mx-auto space-y-6">
                    <div className="bg-white/95 dark:bg-[#12151C] rounded-3xl shadow-sm p-6 sm:p-8 border border-[#EAE2D5] dark:border-[#1F232C] transition-colors duration-300">
                        ...
                        {/* Post Type Stats */}
                        {userPosts.length > 0 && (
                            <div className="mt-6 flex flex-wrap gap-3 justify-center sm:justify-start text-xs font-bold text-stone-600 dark:text-[#8A8F9C]">
                                {Object.entries(postStats).map(([type, count]) => {
                                    ...
                                    return (
                                        <span key={type} className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-stone-100 dark:bg-white/5 border border-[#EAE2D5] dark:border-[#1F232C]">
                        ...
                        <div className="mt-4">
                            {postsLoading ? (
                                ...
                                <div className="text-center py-12">
                                    <p className="text-stone-500 dark:text-[#8A8F9C] font-[Manrope] text-sm">
                                        {activeFilter === 'all'
                                    ...
                                    {filteredPosts.map((post) => {
                                        ...
                                        return (
                                            <Link
                                                key={post._id}
                                                to={`/post/${post._id}`}
                                                className="aspect-square bg-[#FAF7F2] dark:bg-[#1A1E27] rounded-2xl overflow-hidden relative group cursor-pointer border border-[#EAE2D5] dark:border-[#1F232C]"
                                            >
                                                {post.image ? (
                                                    <img
                                                        src={post.image}
