            ...
            <section className="relative z-10 flex-1 flex flex-col items-center justify-center pt-16 pb-24 sm:pt-24 sm:pb-32 px-4 sm:px-6">
                ...
                >
                    ...
                    >
                        <Link
                            to="/register"
                            className="group relative w-full max-w-[230px] sm:w-auto sm:max-w-none px-6 sm:px-8 py-2.5 sm:py-3.5 bg-gradient-to-r from-[#FF8F6B] via-[#D97B4F] to-[#F5C36B] text-[#1A140D] font-black text-xs sm:text-base rounded-full hover:brightness-105 shadow-md hover:scale-105 transition-all duration-300 text-center font-[Manrope] whitespace-nowrap overflow-hidden"
                        >
                            <span className="relative z-10 flex items-center justify-center gap-1.5 sm:gap-2 whitespace-nowrap">
                                Start Your Journey
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="h-3.5 w-3.5 sm:h-4.5 sm:w-4.5 transition-transform group-hover:translate-x-1 shrink-0">
                        ...
                        <Link
                            to="/login"
                            className="w-full max-w-[230px] sm:w-auto sm:max-w-none px-6 sm:px-8 py-2.5 sm:py-3.5 border border-[#EAECF0] dark:border-[#3A3F4B] bg-white dark:bg-white/5 backdrop-blur-md text-[#101828] dark:text-[#E7E6E3] font-bold text-xs sm:text-base rounded-full hover:border-[#D0D5DD] dark:hover:border-[#F5C36B]/60 hover:text-[#D97B4F] dark:hover:text-[#F5C36B] hover:scale-105 shadow-xs transition-all duration-300 text-center font-[Manrope] whitespace-nowrap"
                        >
                            Sign In
                        </Link>
                    </motion.div>
